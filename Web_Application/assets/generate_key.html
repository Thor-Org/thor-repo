    ...
    <header class="masthead" style="background-image:url('assets/img/intro-bg.jpg');">
        <div class="intro-body">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h1>Generate&nbsp;Your Encryption&nbsp;Key</h1><?php
$servername = "97.102.250.88";
$username = "root";
$password = "Sadie1289";
...
              echo "This is Button1 that is selected. Key Generated! <br>";
              // $sql = "SELECT strike_time, lat, lon FROM Lightning_Data.lightning_record";
...
      ?>
                        ...
                        <p>key from our set of lightning data.</p>
                        <form method="post"><button class="btn btn-primary" data-bs-toggle="tooltip" data-bss-tooltip="" type="button" title="Select to generate your key" style="background: #f9603a;border-radius: 8px;"><i class="fa fa-refresh"></i>&nbsp; &nbsp;Generate Key</button><button class="btn btn-primary" data-bs-toggle="tooltip" type="button" name="button1" value="button1" title="Select to generate your key" style="background: #f9603a;border-radius: 8px;"><i class="fa fa-refresh"></i>   Generate Key (real)</button></form>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-auto col-lg-8 col-xl-10 mx-auto">
                    <h2 style="font-size: 43px;margin: 0px;">Key xxx</h2><div><?php echo $strike_time; ?></div>
                    <h2 style="font-size: 43px;margin: 0px;">BIOGRAPHY</h2>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <p class="text-start" style="margin: 35px;">Location: XXXXX</p>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            <tbody style="color: var(--bs-light);">
                                <tr>
                                    <td style="color: var(--bs-white);">Strength:</td>
                                    <td>Cell 2</td>
                                </tr>
                                <tr>
                                    <td>Lifespan:</td>
                                ...
                                <tr>
                                    <td>Lat:</td>
                                    <td><div>1: <?php echo $lat; ?></div>Cell 4</td>
                                </tr>
                                <tr>
                                    <td>Lon</td>
                                    <td><div>2: <?php echo $lon; ?></div>Cell 4</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
